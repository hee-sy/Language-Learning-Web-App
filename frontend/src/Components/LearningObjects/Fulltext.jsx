...
const FulltextP1 = () => {
  ...
  return (
    <div className="my-4 text-sm xl:text-base">
      ...
      <br />
      <p className="mb-3 text-wrap font-normal text-gray-500 dark:text-gray-400">
        Below is the first part of the conversation, <br />
        <span className="italic">
          (Tip: Click on the highlighted words to see their meanings and usage.)
        </span>
      </p>
          ...
          <div className="flex flex-col">
            <pre className="text-wrap font-semibold text-lime-700 dark:text-lime-400">
              <Popover content={konnichiwa} placement="bottom">
                <span
                  onClick={incrementVer} // incrementVer is only called when isAdaptive is true
...
const FulltextP2 = () => {
  ...
  return (
    <div className="my-4 text-sm xl:text-base">
      ...
      <br />
      <p className="mb-3 text-wrap font-normal text-gray-500 dark:text-gray-400">
        Below is the second part of the conversation, <br />
        <span className="italic">
          (Tip: Click on the highlighted words to see their meanings and usage.)
        </span>
      </p>
...
const FulltextP4 = () => {
  ...
  return (
    <div className="my-4 text-sm xl:text-base">
      ...
      <br />
      <p className="mb-3 text-wrap font-normal text-gray-500 dark:text-gray-400">
        Below is the last part of the conversation, <br />
        <span className="italic">
          (Tip: Click on the highlighted words to see their meanings and usage.)
        </span>
      </p>
      ...
      <div id="p1-detail" className="py-6">
        <div className="mb-2 flex flex-row">
          ...
          <div className="flex flex-col">
            <pre className="text-wrap font-semibold text-lime-700 dark:text-lime-400">
              <Popover content={konnichiwa} placement="bottom">
                <span className="font-semibold text-red-500 underline transition-all hover:cursor-pointer hover:text-base hover:decoration-2 xl:hover:text-lg">
                  こんにちは
                </span>
              </Popover>
              ！ あなた
              <Popover content={mo} placement="bottom">
                <span className="font-semibold text-blue-500 underline transition-all hover:cursor-pointer hover:text-base hover:decoration-2 xl:hover:text-lg">
                  も
                </span>
              </Popover>{" "}
              <Popover content={kokode} placement="bottom">
                <span className="font-semibold text-lime-500 underline transition-all hover:cursor-pointer hover:text-base hover:decoration-2 xl:hover:text-lg">
                  ここで
                </span>
              </Popover>
              よく
...
const FulltextP3_A = () => {
  ...
  return (
    <div className="my-4 text-sm xl:text-base">
      ...
      <br />
      <p className="mb-3 text-wrap font-normal text-gray-500 dark:text-gray-400">
        Below is the third part of the conversation, <br />
        <span className="italic">
          (Tip: Click on the highlighted words to see their meanings and usage.)
        </span>
      </p>
