...
const FillBlanks1_A = () => {
  ...
  return (
    <>
      <div className="my-3 w-fit justify-self-center rounded-lg border border-gray-200 bg-white text-sm text-gray-500 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
        <div className="rounded-t-lg border-b border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-600 dark:bg-gray-700">
          <h3 className="font-semibold text-gray-900 dark:text-white">
            Fill in the blank(s):
          </h3>
        ...
        <div className="flex flex-col px-3 py-2">
          <p className="text-wrap text-gray-900">
            今日{"  "}は `_________` なので、あまり 時間が ありません。
          </p>
          <p className="text-wrap italic">
            (Kyō wa _________nanode, amari jikan ga arimasen.)
          </p>
      ...
      <div className="my-3 w-fit justify-self-center rounded-lg border border-gray-200 bg-white text-sm text-gray-500 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
        ...
        <div className="flex flex-col px-3 py-2">
          <p className="text-wrap text-gray-900">
            彼はいつも `_________` けど、仕事が終わった後は遊びに行きます。
          </p>
          <p className="text-wrap italic">
            (Kare wa itsumo _________ kedo, shigoto ga owatta nochi wa asobi ni
            ikimasu.)
  ...
  return (
    <>
      <div className="my-3 w-fit justify-self-center rounded-lg border border-gray-200 bg-white text-sm text-gray-500 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
        ...
        <div className="flex flex-col px-3 py-2">
          <p className="text-wrap text-gray-900">
            私は `_________` が好きで、週末によく小説を読みます。
          </p>
          <p className="text-wrap italic">
            (Watashi wa ______ ga suki de, shuumatsu ni yoku shousetsu o
            yomimasu.)
      ...
      <div className="my-3 w-fit justify-self-center rounded-lg border border-gray-200 bg-white text-sm text-gray-500 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
        ...
        <div className="flex flex-col px-3 py-2">
          <p className="text-wrap text-gray-900">
            この映画はとても `_________` です。ぜひ見てください！
          </p>
          <p className="text-wrap italic">
            (Kono eiga wa totemo ______ desu. Zehi mite kudasai!)
          </p>
    ...
    <div>
      <div className="my-3 w-fit justify-self-center rounded-lg border border-gray-200 bg-white text-sm text-gray-500 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
        ...
        <AnsGroup
          ...
          translations={["weekend", "next time", "very like", "whether or not"]}
        />
      </div>
      <div className="my-3 w-fit justify-self-center rounded-lg border border-gray-200 bg-white text-sm text-gray-500 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
        <div className="rounded-t-lg border-b border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-600 dark:bg-gray-700">
        ...
        <AnsGroup
          ...
          translations={["to play", "very like it", "whether or not", "please"]}
        />
      </div>
    </div>
  );
